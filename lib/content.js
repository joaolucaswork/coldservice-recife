...
export const dtrMappings = {
  ...
  "conserto-geladeira-brastemp": {
    ...
    hero: {
      ...
      subheadline: "Especialistas certificados em Brastemp. Reparo com peças originais, quando necessário. Garantia de 90 dias no serviço.",
  ...
  "conserto-geladeira-electrolux": {
    ...
    hero: {
      ...
      subheadline: "Especialistas certificados em Electrolux. Reparo com peças originais, quando necessário. Garantia de 90 dias no serviço.",
  ...
  "conserto-geladeira-consul": {
    ...
    hero: {
      ...
      subheadline: "Especialistas certificados em Consul. Reparo com peças originais, quando necessário. Garantia de 90 dias no serviço.",
  ...
  "conserto-geladeira-lg": {
    ...
    hero: {
      ...
      subheadline: "Especialistas certificados em LG. Reparo com peças originais, quando necessário. Garantia de 90 dias no serviço.",
  ...
  "conserto-geladeira-samsung": {
    ...
    hero: {
      ...
      subheadline: "Especialistas certificados em Samsung. Reparo com peças originais, quando necessário. Garantia de 90 dias no serviço.",
...
export const services = [
  {
    ...
    description: "Identificamos o problema da sua geladeira e realizamos o conserto completo. A troca de componentes, quando necessária, é feita apenas como parte do serviço.",
    icon: "wrench",
  },
  {
    id: "brastemp",
    title: "Especialistas em Brastemp",
    description: "Reparo especializado para sua geladeira Brastemp, com aplicação de peças originais durante o conserto, se necessário.",
    icon: "star",
  },
  {
    id: "electrolux",
    title: "Especialistas em Electrolux",
    description: "Reparo especializado para sua geladeira Electrolux, com aplicação de peças originais durante o conserto, se necessário.",
    icon: "star",
  },
  {
    id: "consul",
    title: "Especialistas em Consul",
    description: "Reparo especializado para sua geladeira Consul, com aplicação de peças originais durante o conserto, se necessário.",
    icon: "star",
  },
  {
    id: "lg",
    title: "Especialistas em LG",
    description: "Reparo especializado para sua geladeira LG, com aplicação de peças originais durante o conserto, se necessário.",
    icon: "star",
  },
  {
    id: "samsung",
    title: "Especialistas em Samsung",
    description: "Reparo especializado para sua geladeira Samsung, com aplicação de peças originais durante o conserto, se necessário.",
    icon: "star",
  },
  {
    id: "manutencao",
  ...
  },
  {
    ...
    description: "Conserto de máquinas de lavar roupas de todas as marcas. A troca de componentes, quando necessária, é feita apenas como parte do serviço.",
    icon: "wrench",
  },
  {
    id: "cervejeira",
...
export const differentials = [
  ...
  },
  {
    ...
    description: "90 dias de garantia no serviço de conserto realizado.",
    icon: "shield",
  },
  {
    title: "Reparo com Peças Originais",
    description: "Quando o conserto exige troca, aplicamos peças originais e de alta qualidade como parte do serviço. Não vendemos peças avulsas.",
    icon: "check",
  },
  {
...
export const faqItems = [
  ...
  {
    question: "Vocês vendem peças avulsas?",
    answer: "Não. Realizamos apenas o serviço completo de conserto. Quando o reparo exige troca, utilizamos peças originais e de alta qualidade das principais marcas — Brastemp, Electrolux, Consul, LG, Samsung e outras — já inclusas no orçamento do serviço.",
  },
  {
    question: "Preciso levar a geladeira até vocês?",
    answer: "Não! Nosso atendimento é 100% em domicílio. O técnico vai até sua casa ou comércio com todas as ferramentas e itens necessários para o reparo. Na maioria dos casos, o conserto é feito na hora, sem você precisar se deslocar.",
  },
  {
